/**
 * @license MIT
 * Marks from @lobehub/icons-static-svg 1.95.0 (https://github.com/lobehub/lobe-icons),
 * inlined so the dashboard ships thirteen files rather than nine hundred.
 * Regenerate with the script in the PR that added this file.
 */
"use client";
...
const QwenMark = () => {
  ...
  return (
    <svg aria-hidden="true" className="size-3.5" viewBox="0 0 24 24">
      ...
      />
      <defs>
        <linearGradient id={`${uid}-0`} x1="0%" x2="100%" y1="0%" y2="0%">
...
const PathummaMark = () => (
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <path d="M12.05 1 20.34 14.48 15.1 23H8.84L3.7 14.52 12.05 1Zm-.05 10.17-2.12 3.31L12 17.75l2.13-3.27L12 11.17Z" />
  </svg>
);

export const VENDOR_MARKS = new Map<string, VendorMark>([
  ...
  ["meta", { label: "Meta", mark: <MetaMark /> }],
  ["mistral", { label: "Mistral", mark: <MistralMark /> }],
  ["qwen", { label: "Qwen", mark: <QwenMark /> }],
  ["moonshot", { label: "Moonshot", mark: <MoonshotMark /> }],
  ["minimax", { label: "MiniMax", mark: <MinimaxMark /> }],
  ["zhipu", { label: "Zhipu", mark: <ZhipuMark /> }],
  ["bytedance", { label: "ByteDance", mark: <BytedanceMark /> }],
  ["perplexity", { label: "Perplexity", mark: <PerplexityMark /> }],
  ["pathumma", { label: "Pathumma", mark: <PathummaMark /> }],
]);
