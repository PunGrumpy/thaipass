...
This is a reverse-engineered adapter over an undocumented private API. Keep it to a single account you own. The code is MIT, and the rest of the story, from attachments to the edge's refusals, is in the [thaipass guide](https://github.com/PunGrumpy/thaipass/blob/main/docs/guide.md).
